            ...
            <div class="col-md-5 order-details">
                ...
                <div class="order-summary">
                    ...
                    <div class="order-products">
						...
						while ($data = mysqli_fetch_assoc($fetch_cart_result)) {
							$cat_title = $data['prd_title'];
                        ...
                        <div class="order-col">
                            <div><?php echo $cat_title; ?></div>
                            <div><?php echo "₹. "; echo $prd_price; ?></div>
                        </div>
                    ...
                    <div class="order-col">
                        <div><strong>TOTAL</strong></div>
                        <div><strong class="order-total"><?php echo "₹. "; echo $total; ?></strong></div>
                    </div>
                </div>
                ...
                <div class="input-checkbox">
                    ...
                    <input type="checkbox" id="terms" method="POST" name='check' value="yes">
                    <label for="terms">
                        <span></span>
